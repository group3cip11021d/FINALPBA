...
<body>
	...
	<form class="form-horizontal" action="" method="post">
		...
		<div class="form-group">
			...
			<br>
			<div>
				<input class="btn text-light buttons" type="submit" value="ADD">
	...
	<?php
			...
			$gametime = null;
			$venueName = null;
			if(isset($_POST['venue']) && isset($_POST['team1']) && isset($_POST['team2']) && isset($_POST['gamedate']) && isset($_POST['gametime'])){
				$venue = $_POST['venue'];
				$team1 = $_POST['team1'];
				$team2 = $_POST['team2'];
				...
				if($team1 != $team2){
					...
					$arry1 = $arr1[0];
					$arry2 = $arr2[0];
					$sql = "INSERT INTO games(game_venue_id, team_1, team_2, gamedate, gametime, URL_venue, name_venue) VALUES('$venue', '$team1', '$team2', '$gamedate', '$gametime', '$arry1', '$arry2')";
